...
const Header = () => {
    ...
    return (
        <header className='bg-[var(--tg-theme-bg-color)] h-40 lg:h-20 lg:shadow-md  flex flex-col justify-center gap-1 '>
            {
                !(isSearchPage && isMobile) && (
                    <div className="sticky w-full top-0 z-150 bg-[var(--tg-theme-bg-color)] ">
                        <div className='container mx-auto flex items-center px-2 justify-between'>
                          ...
                          {  !isLoginPage&&    <button className='text-[var(--tg-theme-hint-color)] lg:hidden' onClick={handleMobileUser}>
